<template>
    <div :class="classes">
        <input
            ...
            :checked="isChecked"
        />
        <slot name="label" :default-class="'vu-checkbox-label'">
            <label v-if="useLabel" class="vu-checkbox-label" :for="id">
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        const classes = computed(() => {
            const defaultClass = 'vu-checkbox';
